...
public class OClusterPageSetNextRecordPointerPageOperation extends OPageOperation {
  ...
  @Override
  public byte getId() {
    return WALRecordTypes.CLUSTER_PAGE_SET_NEXT_RECORD_POINTER_PAGE_OPERATION;
  }
}
